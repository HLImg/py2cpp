...
class CMDSRnet(nn.Module):
    def __init__(self,scale_factor=4, use_support_Mod=True, task_size=1, support_size=20, input_channels=3, kernel_size=3, channels=64, n_block=10, n_conv_each_block=2, residual_lr=1, conv_index='22'):
        super(CMDSRnet, self).__init__()
